...
def get_random_config():
    ...
    aj1 = (random.uniform(hjMin['raj1'], hjMax['raj1']), random.uniform(hjMin['raj1'], hjMax['raj1']))
    aj2 = (random.uniform(hjMin['raj2'], hjMax['raj2']), random.uniform(hjMin['raj2'], hjMax['raj2']))
    aj3 = (random.uniform(hjMin['raj3'], hjMax['raj3']), random.uniform(hjMin['raj3'], hjMax['raj3']))
    aj4 = (random.uniform(hjMin['raj4'], hjMax['raj4']), random.uniform(hjMin['raj4'], hjMax['raj4']))
...
if __name__ == '__main__':
    count = 0
    best = [-72.34717954936539, -86.51053260472672, -38.7623661663499, -18.799368695355913, 40.81958839913602, 19.12164934152415, -47.67114379568846, -27.249608046991227, -45.0, 8.00333015187915, -21.62330893977991, 8.283949493234834, -87.33519436536716, -5.91344870934591, -67.35219147966598, -1.0, -5.933479241033146, 45.236302993993874, 11.782836883591173, 1.0]
    ...
    agent.set_walk_config(congigure_vector(best))
        # time.sleep(0)
        # print("Now Ki2lling")
